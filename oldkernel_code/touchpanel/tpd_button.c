...
#ifdef ECLIPSE_TOUCHPANEL_GUSTURE_SUPPORT
	__set_bit(KEY_DOUBLE_CLICK_GESTURE, tpd->dev->keybit);
	__set_bit(KEY_C_ALPHABET_GESTURE, tpd->dev->keybit);
	__set_bit(KEY_M_ALPHABET_GESTURE, tpd->dev->keybit);
	__set_bit(KEY_LEFT_SLIPE_GESTURE, tpd->dev->keybit);
	__set_bit(KEY_RIGHT_SLIPE_GESTURE, tpd->dev->keybit);
#endif
