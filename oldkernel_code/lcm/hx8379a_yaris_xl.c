...
#define DOT_NO_OTP_FLAG                                                                       (0x83)
#define COLUMN_OTP_FLAG                                                                             (0x55)
...
static int Otp_flag = 0; //for distinguish LCD adopted dot turn method or column turn way
...
if(Otp_flag == 0)
{
//LCD Dot-Column by Aaron Start
      //for read DA to distingish LCD include OTP
      unsigned char buff_otp[6] = {0};
      data_array[0] = 0x00023700;
	dsi_set_cmdq(&data_array, 1, 1);
    	MDELAY(10); 
       read_reg_v2(0xDA,buff_otp, 2);
	  Otp_flag = buff_otp[1];
//LCD Dot-Column by Aaron End
...
//SET GAMMA 2.2 0806
	...
	data_array[1]=0x090779E0;
	data_array[2]=0x3F16150A;
	data_array[3]=0x12063827;
	data_array[4]=0x14161410;
	data_array[5]=0x07171115;
	data_array[6]=0x16150A09;
	data_array[7]=0x0638273F;
	data_array[8]=0x16141012;
	data_array[9]=0x17111514;
...
#ifdef BUILD_LK
    printf("%s, lcm_compare_id LK  debug: hx8379a_yaris_xl lcd_id = 0x%08x\n", __func__, lcd_id_ic);
    printf("%s, lcm_compare_id LK  debug: hx8379a_yaris_xlDA  buff_otp[0] = 0x%08x ,\nbuff_otp[1] = 0x%08x ,\n", \
		__func__,buff_otp[0],buff_otp[1]);
#else
    printk("%s, lcm_compare_id kernel  horse debug: hx8379a_yaris_xl lcd_id = 0x%08x\n", __func__, lcd_id_ic);
    printk("%s, lcm_compare_id LK  debug: hx8379a_yaris_xlDA buff_otp[0] = 0x%08x ,\nbuff_otp[1] = 0x%08x ,\n", \
		__func__,buff_otp[0],buff_otp[1]);
