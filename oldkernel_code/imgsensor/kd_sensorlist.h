...
#endif
UINT32 OV8850_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);//zuoyong add for eclipse
UINT32 HI258_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);//20131118 add by zuoyong for yaris xxl second source
...
#endif
#if defined(HI258_YUV)//20131118 add by zuoyong for yaris xxl second source
