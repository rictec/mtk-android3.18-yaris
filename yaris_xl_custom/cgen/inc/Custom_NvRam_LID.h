...
#define JRD_AUDIO_PARAMETER_VER 	"014" /*1.4*/
/* verno of data items */
/* audio file version */
...
#define AP_CFG_RDCL_FILE_AUDIO_COMPFLT_LID_VERNO	JRD_AUDIO_PARAMETER_VER

/* audio hcf file version */
#define AP_CFG_RDCL_FILE_HEADPHONE_COMPFLT_LID_VERNO	JRD_AUDIO_PARAMETER_VER

/* audio effect file version */
#define AP_CFG_RDCL_FILE_AUDIO_EFFECT_LID_VERNO	JRD_AUDIO_PARAMETER_VER

/* audio med file version */
#define AP_CFG_RDCL_FILE_AUDIO_PARAM_MED_LID_VERNO  JRD_AUDIO_PARAMETER_VER

/* audio volume custom file version */
#define AP_CFG_RDCL_FILE_AUDIO_VOLUME_CUSTOM_LID_VERNO  JRD_AUDIO_PARAMETER_VER
#define AP_CFG_RDCL_FILE_AUDIO_VER1_VOLUME_CUSTOM_LID_VERNO  JRD_AUDIO_PARAMETER_VER

/* dual mic custom file version */
#define AP_CFG_RDCL_FILE_DUAL_MIC_CUSTOM_LID_VERNO  JRD_AUDIO_PARAMETER_VER

/* audio wb specch param custom file version */
#define AP_CFG_RDCL_FILE_AUDIO_WB_PARAM_LID_VERNO JRD_AUDIO_PARAMETER_VER

/* audio gain table custom file version */
#define AP_CFG_RDCL_FILE_AUDIO_GAIN_TABLE_LID_VERNO JRD_AUDIO_PARAMETER_VER

/* audio hd record par custom file version*/
#define AP_CFG_RDCL_FILE_AUDIO_HD_REC_PAR_LID_VERNO JRD_AUDIO_PARAMETER_VER
#define AP_CFG_RDCL_FILE_AUDIO_HD_REC_SCENE_LID_VERNO JRD_AUDIO_PARAMETER_VER
#define AP_CFG_RDCL_FILE_AUDIO_HD_REC_48K_PAR_LID_VERNO JRD_AUDIO_PARAMETER_VER

/* audio buffer dc calibration custom file version*/
#define AP_CFG_RDCL_FILE_AUDIO_BUFFER_DC_CALIBRATION_PAR_LID_VERNO JRD_AUDIO_PARAMETER_VER
